                ...
                {processes.map((process, index) => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-3">
                            <h4 className="font-medium text-gray-900 dark:text-white text-lg">{process.title}</h4>
                            <div className="process-icon w-12 h-12 rounded-full flex items-center justify-center shadow-md">
                                <FontAwesomeIcon 
                                    icon={process.icon} 
