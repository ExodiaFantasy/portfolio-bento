...
export const featuredCertifications = [
    {
        ...
        image: null, // Will be populated by Credly sync
        proofArchive: [
            'https://www.credly.com/badges/aa4e9d36-bd04-45dd-bad7-1803e39a6aea/public_url', // Early Adopter variant
            '/Certificates/AWS- AI Practitioner Certificate.pdf',
            '/Certificates/AWS- AI Practitioner.png'
        ]
    },
    {
...
export const professionalTraining = [
    {
        ...
        componentCount: 30,
        components: [
            { title: 'Connect APIs Intermediate', proof: '/Certificates/AWS- Connect APIs Intermediate.pdf' },
            { title: 'Connect Agent Applications Fundamentals', proof: '/Certificates/AWS- Connect Agent Applications Fundamentals.pdf' },
            { title: 'Connect Chat and Messaging Fundamentals', proof: '/Certificates/AWS- Connect Chat and Messaging Fundamentals.pdf' },
            { title: 'Connect Chat and Messaging Intermediate', proof: '/Certificates/AWS- Connect Chat and Messaging Intermediate.pdf' },
            { title: 'Connect Communications Specialist Assessment', proof: '/Certificates/AWS- Connect Communications Specialist Assessment.pdf' },
            { title: 'Connect Console Fundamentals', proof: '/Certificates/AWS- Connect Console Fundamentals.pdf' },
            { title: 'Connect Contact Lens Fundamentals', proof: '/Certificates/AWS- Connect Contact Lens Fundamentals.pdf' },
            { title: 'Connect Conversational Interfaces Fundamentals', proof: '/Certificates/AWS- Connect Conversational Interfaces Fundamentals.pdf' },
            { title: 'Connect Conversational Interfaces Intermediate', proof: '/Certificates/AWS- Connect Conversational Interfaces Intermediate.pdf' },
            { title: 'Connect Custom Contact Control Panel Fundamentals', proof: '/Certificates/AWS- Connect Custom Contact Control Panel Fundamentals.pdf' },
            { title: 'Connect Custom Contact Control Panel Intermediate', proof: '/Certificates/AWS- Connect Custom Contact Control Panel Intermediate.pdf' },
            { title: 'Connect Customer Profiles Fundamentals', proof: '/Certificates/AWS- Connect Customer Profiles Fundamentals.pdf' },
            { title: 'Connect Data Streaming Intermediate', proof: '/Certificates/AWS- Connect Data Streaming Intermediate.pdf' },
            { title: 'Connect Flows Fundamentals', proof: '/Certificates/AWS- Connect Flows Fundamentals.pdf' },
            { title: 'Connect Flows Intermediate', proof: '/Certificates/AWS- Connect Flows Intermediate.pdf' },
            { title: 'Connect Flows Lambda Integration Fundamentals', proof: '/Certificates/AWS- Connect Flows Lambda Integration Fundamentals.pdf' },
            { title: 'Connect Flows Lambda Integration Intermediate', proof: '/Certificates/AWS- Connect Flows Lambda Integration Intermediate.pdf' },
            { title: 'Connect Instance Fundamentals', proof: '/Certificates/AWS- Connect Instance Fundamentals.pdf' },
            { title: 'Connect Integrations Intermediate', proof: '/Certificates/AWS- Connect Integrations Intermediate.pdf' },
            { title: 'Connect Introduction', proof: '/Certificates/AWS- Connect Introduction.pdf' },
            { title: 'Connect Optimizing Routing Solutions', proof: '/Certificates/AWS- Connect Optimizing Routing Solutions.pdf' },
            { title: 'Connect Routing Fundamentals', proof: '/Certificates/AWS- Connect Routing Fundamentals.pdf' },
            { title: 'Connect Routing Intermediate', proof: '/Certificates/AWS- Connect Routing Intermediate.pdf' },
            { title: 'Connect Voice Intermediate', proof: '/Certificates/AWS- Connect Voice Intermediate.pdf' },
            { title: 'Connect and EventBridge Intermediate', proof: '/Certificates/AWS- Connect and EventBridge Intermediate.pdf' }
        ],
        proofArchive: [
            '/Certificates/AWS- Connect Developer.png',
            '/Certificates/AWS- Connect Communications Specialist.png'
        ]
    },
    {
        ...
        componentCount: 5,
        components: [
            { title: 'Foundations of Prompt Engineering', proof: '/Certificates/AWS - Foundations of Prompt Engineering.pdf' },
            { title: 'Generative AI Professional Domain 1', proof: '/Certificates/AWS -  Gen AI Professional Domain 1.pdf' },
            { title: 'Official Pretest: Certified Generative AI Professional', proof: '/Certificates/AWS - Official Pretest AWS Certified Generative AI Professional.pdf' },
            { title: 'Automate Handout Creation with BDA and Step Functions', proof: '/Certificates/AWS- Automate Handout Creation with BDA and Step Functions.pdf' },
            { title: 'Building Secure and Responsible GenAI with GuardRails for Amazon Bedrock', proof: '/Certificates/AWS- Building Secure and Responsible Gen AI with GuardRails for Amazon Bedrock pdf.pdf' }
        ]
    },
    {
        ...
        componentCount: 6,
        components: [
            { title: 'AWS Cloud Practitioner Essentials', proof: '/Certificates/AWS- AWS Cloud Practitioner Essentials.pdf' },
            { title: 'Cloud Essentials Knowledge Badge Assessment', proof: '/Certificates/AWS- Cloud Essentials Knowledge Badge Assessment.pdf' },
            { title: 'Foundations Getting Started with AWS Cloud Essentials', proof: '/Certificates/AWS- Foundations Getting Started with AWS Cloud Essentials.pdf' },
            { title: 'Getting Started with Cloud Acquisition', proof: '/Certificates/AWS- Getting Started with Cloud Acquisition.pdf' },
            { title: 'Infrastructure as Code Fundamentals', proof: '/Certificates/AWS- Infrastracture as Code Fundamentals.pdf' },
            { title: 'Job Roles in the Cloud', proof: '/Certificates/AWS- Job Roles in the Cloud.pdf' }
        ],
        proofArchive: [
            '/Certificates/AWS- Cloud Essentials-Knowledge Badge Readiness Path.pdf',
            '/Certificates/AWS- Cloud Essentials.png'
        ]
    },
    {
        ...
        componentCount: 2,
        components: [
            { title: 'Data Analytics Bootcamp', proof: '/Certificates/Alex the Analyst- Data Analytics Bootcamp.pdf' },
            { title: 'Analytics Bootcamp Certification', proof: '/Certificates/Verified Analytics Bootcamp Certification.png' }
        ]
    },
    {
        ...
        componentCount: 4,
        components: [
            { title: 'Data, Data, Everywhere', proof: '/Certificates/Google- Data, Data, Everywhere.pdf' },
            { title: 'Data Analytics Capstone', proof: '/Certificates/Google- Data Analytics Capstone.pdf' },
            { title: 'The Nuts and Bolts of Machine Learning', proof: '/Certificates/Google- The nuts and bolts of Machine Learaning.pdf' },
            { title: 'Simple Linear Regression for the Absolute Beginner', proof: '/Certificates/Cousera - Simple Linear Regression for the Absolute.pdf' }
        ]
    },
    {
        ...
        componentCount: 2,
        components: [
            { title: 'Introduction to AI', proof: '/Certificates/Google - Introduction to AI.pdf' },
            { title: 'Accelerate Your Job Search with AI', proof: '/Certificates/Google- Accelerate Your Job Search with AI.pdf' }
        ]
    }
];
...
// ============================================================================
export const learningArchive = [
    // Introductory courses (not role-critical)
    {
    ...
    // Duplicate proof files (PDF/PNG variants of featured/professional items)
    {
        ...
        note: "Duplicate of Featured: AWS Certified AI Practitioner"
    },
    {
    ...
    },
    {
        ...
        note: "Duplicate of Featured: AWS Certified Cloud Practitioner"
    },
    {
        title: "Cloud Practitioner (duplicate)",
        issuer: "AWS",
    ...
    },
    {
        ...
        note: "Duplicate of Professional: AWS Connect Developer Specialist"
    },
    {
...
// ============================================================================
// LEGACY: Original flat structure (preserved for backward compatibility)
// ============================================================================
